...
HEADER = np.array((0x52, 0x49, 0x46, 0x46, 0x4A, 0xB1, 0x00, 0x00, 0x57, 0x41, 0x56, 0x45, 0x66,
                   0x6D, 0x74, 0x20,
                   0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x22, 0x56, 0x00, 0x00, 0x44,
                   0xAC, 0x00, 0x00,
                   0x02, 0x00, 0x10, 0x00, 0x64, 0x61, 0x74, 0x61, 0x00, 0xF0, 0xFF, 0x7F),
                  dtype=np.uint8).view(np.uint16)
